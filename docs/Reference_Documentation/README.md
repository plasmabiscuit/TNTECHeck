...
| NSF Award Search | `nsf_award_search` adapter | **Needs docs** | _No source-specific folder yet_ | Add canonical API doc digest, query templates, and response normalization notes |
