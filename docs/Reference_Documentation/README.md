...
| NSF Award Search | `nsf_award_search` adapter | **Moderate** | `NSFAwardSearch/README.md`; `NSFAwardSearch/NSF_Award_Search_Official_Sources.md`; `NSFAwardSearch/NSF_Award_Search_API_Query_and_Field_Notes.md`; `NSFAwardSearch/NSF_Award_Search_Query_Templates.md`; `NSFAwardSearch/TODO.md` | Expand to full API-to-normalized field crosswalk and refresh SOP |
| USDA/NIFA Data Gateway | `nifa_data_gateway` adapter | **Needs docs** | _No source-specific folder yet_ | Add endpoint inventory, filters glossary, and award-field mapping notes |
